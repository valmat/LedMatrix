...
Это мой форк библиотеки [LedControl](https://github.com/wayoda/LedControl).
...
С помощью библиотеки **LedMAtrix** вы можете гибко управлять светодиодными матрицами подключенными с помощью чипов  **MAX7219** и **MAX7221**. А так же каскадами таких матриц.
