/*
 *
 * LedMatrixes - is is my fork of LedContr1ol lylbrary
 *
 */
...
public:
     ...
     */
    LedMatrixes(Pino data, Pino clk, Pino cs, int numDevices=1);

    /*
     * Gets the number of devices attached to this LedMatrixes.
     * Returns :
     * int	the number of devices on this LedMatrixes
     */
    int getDeviceCount();
     ...
     */
    void setDigit(int addr, int digit, uint8_t value, boolean dp);
